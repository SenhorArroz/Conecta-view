    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <nav className="navbar bg-white shadow-md px-4 md:px-12 sticky top-0 z-50 border-b border-gray-100">
        ...
        <div className="flex">
          <ul className="menu menu-horizontal px-1 font-bold text-slate-700 hidden md:flex">
            <li><a href="/sobre" className="hover:text-[#ff9324]">Sobre</a></li>
          </ul>
          <a href='/login' className="btn bg-[#248ebe] hover:bg-[#1a6fb3] ml-4 text-white border-none shadow-md">
            Acessar Sistema
          </a>
        </div>
      </nav>

      {/* Hero Section - Agora usando o Azul correto como fundo */}
        ...
        <div className="hero-content text-center">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mt-4">
              <button className="btn bg-[#ff9324] hover:bg-[#e07d1d] btn-lg shadow-2xl text-white border-none px-10">
                Começar Agora
              </button>
              <button className="btn btn-outline btn-lg border-white text-white hover:bg-white hover:text-[#248ebe] px-10">
                Ver Ranking
              </button>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <article className="card bg-white shadow-xl reveal border-t-4 border-[#ff9324] hover:shadow-2xl transition-all duration-300">
            <div className="card-body items-center text-center">
              <div className="w-16 h-16 bg-[#fff4e6] rounded-full flex items-center justify-center text-3xl mb-4">👥</div>
          ...
          <article className="card bg-white shadow-xl reveal border-t-4 border-[#248ebe] hover:shadow-2xl transition-all duration-300">
            <div className="card-body items-center text-center">
              <div className="w-16 h-16 bg-[#e9f3fb] rounded-full flex items-center justify-center text-3xl mb-4">🎁</div>
      ...
      <footer className="footer footer-center p-12 bg-[#248ebe] text-white">
        <aside>
          ...
          <p className="opacity-40 text-xs">Made by: Luiz Guimarães</p>
        </aside>
      </footer>
    </div>
  );
